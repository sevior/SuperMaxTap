 ...
 * @author junior
 */
public class CadastroModoView1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Catecoria", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(45, 76, 139))); // NOI18N
        ...
        jButton22.setBackground(new java.awt.Color(45, 76, 139));
            ...
            if (jComboBoxOp.getSelectedItem().equals("JDBC")) {
                try {
                    ...
                    if (!conn.equals(null)) {
                        ...
                        stm.executeUpdate("insert into `modocompra` (`modo`) values ('" + txtCategoria.getText() + "');");
                        JOptionPane.showMessageDialog(null, "Modo cadastrada com sucesso!");
                    }
                ...
                control.salvar(new ModoCompra(txtCategoria.getText().toUpperCase()));
                JOptionPane.showMessageDialog(null, "Modo cadastrada com sucesso!");
                this.limparCampos();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroModoView1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroModoView1().setVisible(true);
            }
        });
    }
